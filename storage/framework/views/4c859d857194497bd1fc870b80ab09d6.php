<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            ...
            <span class="font-weight-bold text-lg">AkiraZone</span>
        </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  <?php echo e(is_current_route('dashboard') ? 'active' : ''); ?>"
            ...
            <li class="nav-item">
                <a class="nav-link  <?php echo e(is_current_route('tables') ? 'active' : ''); ?>" href="<?php echo e(route('tables')); ?>">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link <?php echo e(is_current_route('wallet') ? 'active' : ''); ?> " href="<?php echo e(route('wallet')); ?>">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link  <?php echo e(is_current_route('RTL') ? 'active' : ''); ?>" href="<?php echo e(route('RTL')); ?>">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 <?php echo e(is_current_route('users.profile') ? 'active' : ''); ?>"
                    href="<?php echo e(route('users.profile')); ?>">
                    <span class="nav-link-text ms-1">User Profile</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 <?php echo e(is_current_route('users-management') ? 'active' : ''); ?>"
                    href="<?php echo e(route('users-management')); ?>">
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 <?php echo e(is_current_route('profile') ? 'active' : ''); ?>"
                    href="<?php echo e(route('profile')); ?>">
                    <span class="nav-link-text ms-1">Profile</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 <?php echo e(is_current_route('signin') ? 'active' : ''); ?>"
                    href="<?php echo e(route('signin')); ?>">
                    <span class="nav-link-text ms-1">Sign In</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 <?php echo e(is_current_route('signup') ? 'active' : ''); ?>"
                    href="<?php echo e(route('signup')); ?>">
...
<?php /**PATH /home/shoxsx/code/CRM/resources/views/components/app/sidebar.blade.php ENDPATH**/ ?>