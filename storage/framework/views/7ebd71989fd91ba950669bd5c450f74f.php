                        ...
                        <div class="col-xl-4 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent">
                                    <h3 class="font-weight-black text-dark display-6 text-center">Esqueceu a senha?</h3>
                                    <p class="mb-0 text-center">Digite seu e-mail abaixo!</p>
                                </div>
                                <?php if($errors->any()): ?>
                                ...
                                <div class="card-body">
                                    <form role="form" action="/forgot-password" method="POST">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" class="my-4 mb-2 btn btn-dark btn-lg w-100">Link para redefinição de senha de e-mail</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="position-absolute w-40 top-0 end-0 h-100 d-md-block d-none">
                                <div class="oblique-image position-absolute fixed-top ms-auto h-100 z-index-0 bg-cover ms-n8"
                                    style="background-image:url('../assets/img/image-forget.png')">
                                    <div
                                        class="blur mt-12 p-4 text-center border border-white border-radius-md position-absolute fixed-bottom m-4">
                                        <h2 class="mt-3 text-dark font-weight-bold">Não se preocupe, vamos te ajudar a voltar para o seu universo de animes!</h2>
                                        <h6 class="text-dark text-sm mt-5">Todos os direitos reservados © AkiraZone
                                            <script>
                                                document.write(new Date().getFullYear())
                                            </script>.
                                            A aventura só está começando, e você é parte dela!
                                        </h6>
                                    </div>
                                </div>
                            </div>
...
<?php endif; ?>
<?php /**PATH /home/shoxsx/code/CRM/resources/views/auth/passrecover/forgot-password.blade.php ENDPATH**/ ?>